...
- paste your wallet mnemonic in `./packages/bundler/localconfig/mnemonic.txt` file.
- paste your infura project id in provider section of `./packages/bundler/src/runbundler.ts` file.
